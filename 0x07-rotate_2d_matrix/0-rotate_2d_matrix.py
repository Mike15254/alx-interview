#!/usr/bin/python3
"""
Defines function that can rotate 2D n x n matrix 90 degrees clockwise in place
"""


def rotate_2d_matrix(matrix):
    """
    Rotates 2D n x n matrix 90 degrees clockwise in place
    parameters:
    ...
    # since matrix is n x n, do not need to resize matrix for rotation
    for row in range(N):
        for column in range(N):
